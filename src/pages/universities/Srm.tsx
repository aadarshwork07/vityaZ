        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button 
              ...
              className="flex items-center gap-2 bg-white text-green-600 px-4 py-2 rounded-lg border border-green-600 hover:bg-green-50 transition"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-grow">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="relative h-48 rounded-xl overflow-hidden">
                <img 
                  src="https://www.srmist.edu.in/wp-content/uploads/2021/10/Students-7.jpg"
                  alt="SRM Students"
                  className="w-full h-full object-cover"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <div className="mt-6 space-y-3">
              ...
              <button 
                onClick={handleDownload}
                className="w-full bg-white border border-green-600 text-green-600 py-2 rounded-lg hover:bg-green-50 transition flex items-center justify-center gap-2"
              >
                <Download className="w-4 h-4" />
                Download Brochure
              </button>
