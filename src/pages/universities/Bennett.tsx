...
function Bennett() {
  ...
  const handleDownload = () => {
    ...
    link.href = universityData.code; // File path in public directory
    // Set the download attribute to give the file a name
    link.download = "Bennett_University_Brochure.pdf";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-grow">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="relative h-48 rounded-xl overflow-hidden">
                <img 
                  src="https://www.mycampusreview.com/assest/front/images/fb/bennut_students.jpg"
