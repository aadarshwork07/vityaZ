        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button 
              ...
              className="flex items-center gap-2 bg-white text-blue-600 px-4 py-2 rounded-lg border border-blue-600 hover:bg-blue-50 transition"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-grow">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="relative h-48 rounded-xl overflow-hidden">
                <img 
                  src="https://www.symbiosis.ac.in/images/university/SIU-students.jpg"
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <div className="mt-6 space-y-3">
              ...
              <button 
                onClick={handleDownload}
                className="w-full bg-white border border-blue-600 text-blue-600 py-2 rounded-lg hover:bg-blue-50 transition flex items-center justify-center gap-2"
              >
                <Download className="w-4 h-4" />
                Download Brochure
              </button>
