        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button 
              ...
              className="flex items-center gap-2 bg-white text-red-600 px-4 py-2 rounded-lg border border-red-600 hover:bg-red-50 transition"
            >
              <Download className="w-4 h-4" />
              Brochure
            </button>
            <a href="/global-admissions" className="inline-block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 flex-grow">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="relative h-48 rounded-xl overflow-hidden">
                <img 
                  src="https://amity.edu/jaipur/images/Amity-Campus.jpg"
                  alt="Amity Students"
                  className="w-full h-full object-cover"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <div className="mt-6 space-y-3">
              <Link to="/apply" className="block w-full">
                <button className="w-full bg-red-600 text-white py-2 rounded-lg hover:bg-red-700 transition flex items-center justify-center gap-2">
                  Apply for Admission
                </button>
              </Link>
              <button 
                onClick={handleDownload}
                className="w-full bg-white border border-red-600 text-red-600 py-2 rounded-lg hover:bg-red-50 transition flex items-center justify-center gap-2"
              >
                <Download className="w-4 h-4" />
                Download Brochure
              </button>
