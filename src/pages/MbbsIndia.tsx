    ...
    <div className="pt-24">
      ...
      <section className="bg-gradient-to-r from-rose-50 to-rose-100 dark:from-gray-800 dark:to-gray-900 py-20">
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl text-black dark:text-gray-300 max-w-2xl mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              to="/apply"
              className="bg-rose-600 text-black px-8 py-3 rounded-lg font-semibold hover:bg-rose-700 transition-colors"
            >
              Apply Now
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {specializations.map((spec, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <p className="text-black dark:text-gray-300">{spec.description}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            {universities.map((university, index) => (
              <div key={index} className="bg-gray-50 dark:bg-gray-700 rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2 text-black dark:text-gray-300 mb-4">
                  ...
                  <ul className="space-y-2">
                    {university.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center gap-2 text-black dark:text-gray-300">
              ...
              {admissionProcess.map((step) => (
                <div key={step.step} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-8 h-8 bg-rose-600 text-black rounded-full flex items-center justify-center font-bold">
                      {step.step}
                    </div>
                    <div className="flex-grow">
                      <h3 className="text-xl font-semibold mb-2">{step.title}</h3>
                      <p className="text-black dark:text-gray-300 mb-4">{step.description}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {feeStructure.additionalFees.map((fee, index) => (
                <div key={index} className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                  ...
                  <p className="text-black dark:text-gray-300">{fee.frequency}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {/* Call to Action */}
      <section className="py-20 bg-rose-600 text-black">
